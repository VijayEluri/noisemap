package maris.learning.serialize;
...
public class MyLibrary implements Serializable {
	...
	public static void main(String[] args) {
		...
		try{
			...
			System.out.println( "at " + e.getStackTrace()[0].toString() );
			System.out.println( "at " + e.getStackTrace()[1].toString() );
		}
	}
	...
	public String toString() {
		...
		for(Book book : this.getBooks()){
			text+="("+book.getTitle()+","+book.getAuthor()+","+book.getPerson()+")\n";
		}
